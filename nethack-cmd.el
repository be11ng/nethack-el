...
;;   (interactive)
;;   (nethack-send-command (symbol-name command)))
...
(defun nethack-command-identify-trap ()
  ...
  (interactive)
  (nethack-send-command "doidtrap"))


(defun nethack-command-apply ()
  "a       Apply (use) a tool"
  (interactive)
  (nethack-send-command "doapply"))

(defun nethack-command-remove-all-armor ()
  "A       Remove all armor"
  (interactive)
  (nethack-send-command "doddoremarm"))
...
(defun nethack-command-show-all-equipment-in-use ()
  ...
  (interactive)
  (nethack-send-command "doprinuse"))
