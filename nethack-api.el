...
(defconst nethack-api-wmenu nil)			;NHW_MENU (inventory or other "corner" windows) 
(defconst nethack-api-wtext nil)			;NHW_TEXT (help/text, full screen paged window)
...
(defun nethack-api-getch ()
  "
int nhgetch()	-- Returns a single character input from the user. (int)
...
(defun init-nhwindows (argcp argv)
  "
